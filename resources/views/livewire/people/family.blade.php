<div class="flex flex-col rounded p-2 bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 text-neutral-800 dark:text-neutral-50">
...
{{--            @dd(\Illuminate\Support\Facades\Auth::id() === $person->created_by)--}}
    ...
    <div class="grid grid-cols-6">
        ...
        <div class="col-span-2 pl-2 py-2 border-b">
        ...
        <div class="col-span-2 pl-2 py-2">

{{--            {{ __('person.partner') }}--}}
            {{ $person?->mother?->sex == 'm' ?  __('person.wife') : __('person.husband') }}
